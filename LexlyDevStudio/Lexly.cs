...
namespace LexlyDevstudio
{
    using Process = System.Diagnostics.Process;

    [PackageRegistration(UseManagedResourcesOnly = true)]
    [InstalledProductRegistration("Lexly", "Generate simple DFA lexers", "0.2.0.0")]
    [Guid("A2CAAED0-DC33-4C01-8D74-5C448E6A3E0B")]
    [ComVisible(true)]
    [ProvideObject(typeof(Lexly))]
    [CodeGeneratorRegistration(typeof(Lexly), "Lexly", "{FAE04EC1-301F-11D3-BF4B-00C04F79EFBC}", GeneratesDesignTimeSource = true)]
    [CodeGeneratorRegistration(typeof(Lexly), "Lexly", "{164b10b9-b200-11d0-8c61-00a0c91e29d5}", GeneratesDesignTimeSource = true)]
    public sealed class Lexly : IVsSingleFileGenerator, IObjectWithSite
    {
        object _site;
        Array _projects;
